...
// Real brand marks (single-path, official brand color), sourced from the
// `simple-icons` package rather than hand-drawn — verified against
// node_modules/simple-icons/icons/{facebook,instagram,tiktok}.svg and
// node_modules/simple-icons/data/simple-icons.json for the hex values, so
// these are the actual logos rather than an approximation.
